---
layout: post
title: "Module-Federation 기반 Micro Frontend 구축"
date: 2021-05-28
excerpt: "자바스크립트에서 모듈이란 js로 이루어진 작은 기능단위 코드를 지칭한다. 하지만 webpack은 js 모듈 뿐만 아니라 스타일시트, 이미지 등 모든 것을 자바스크립트 모듈로 로딩해서 사용한다. 이러한 웹팩에서 지원하는 Webpack plugin 중 하나인 `Module Federation`은 Micro Frontend 프레임워크를 구현하는 것에 도움을 준다."
project: true
tag:
  - webpack
  - micro-frontend
